# bash >= 3 completion for mock-urpm(1)

_mock-urpm()
{
    COMPREPLY=()
    local cur prev cword cfgdir=/etc/mock-urpm
    local -a words
    ...
    if [[ "$cur" == -* ]] ; then
        COMPREPLY=( $( compgen -W "--version --help --rebuild --buildsrpm
            ...
            --update --orphanskill --copyin --copyout --root
...
complete -F _mock-urpm -o filenames mock-urpm mock-urpm.py
